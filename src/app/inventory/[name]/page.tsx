...
const CarDetails = () => {
  ...
  return (
    <>
      <div className="pageTitle py-4 mt-16 shadow-lg gradient-bg">
          ...
          <div className="mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 text-gray-900 dark:text-white">
            ...
            <div>
              ...
              <div className="text-2xl mt-10 mb-4">
                ...
                <ul className="list-disc pl-5 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className=" w-90 mr-20">
              <div className="gradient-bg rounded-lg shadow-md p-6 w-90 mr-20 mx-auto mb-5">
              ...
              {/* stay safe */}
              <div className="gradient-bg rounded-lg shadow-md p-6 w-90 h-90 mr-20  mx-auto">
