...
const OurBrand = () => {
  return (
    <div className="container mx-auto p-4 pt-6 md:p-6 lg:px-12 mt-4 mb-4 text-center bg-gray-200 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-5 mb-4">
        {CarBrands.map((brand, index) => (
          <div key={index} className="relative flex flex-col items-center justify-center group mt-7 mb-5 bg-white dark:bg-white p-4 rounded-md shadow-md">
            ...
            <h3 className="mt-4 font-bold text-lg text-black dark:text-white">{brand.name}</h3>
